...
class DetectorTest(unittest.TestCase):
    def test_detects_changes_against_state_and_persists(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            versions.write_text(json.dumps({"agp": "9.2.0", "kotlin": "2.3.20"}), encoding="utf-8")
            state.write_text(json.dumps({"agp": "9.1.0", "kotlin": "2.3.20"}), encoding="utf-8")
            ...
            self.assertEqual({"agp": "9.2.0", "kotlin": "2.3.20"}, json.loads(state.read_text(encoding="utf-8")))
